...
namespace DSPRE.Resources {
    public static class ScriptDatabase {  
        ...
        public static Dictionary<ushort, string> HGSSScrCmdNames = new Dictionary<ushort, string>() {
            ...
            [0x0054] = "FadeOutMusic",
            [0x0055] = "FadeInMusic",
            [0x0056] = "BgmPlayerPause",
            [0x0057] = "PlayerFieldDemoBgmPlay",
            [0x0058] = "CtrlBgmFlagSet",
            [0x0059] = "CheckChatotCry",
            [0x005A] = "StartChatotCry",
            [0x005B] = "StopChatotCry",
            [0x005C] = "SaveChatotCry",
            [0x005D] = "SndClimaxDataLoad",
            [0x005E] = "Movement",
            [0x005F] = "WaitMovement",
            [0x0060] = "LockAll",
            [0x0061] = "ReleaseAll",
            ...
            [0x0085] = "CBItemNumGet",
            [0x0086] = "CBItemNumAdd",
            [0x0087] = "CBItemRandomGet",
            [0x0088] = "UnknownFormGet",
            [0x0089] = "GivePokemon",
            [0x008A] = "GivePokemonEgg",
            [0x008B] = "ReplaceMove",
            [0x008C] = "CheckPokemonHasMove",
            [0x008D] = "CheckMoveInParty",
            [0x008E] = "RevengeTrainerSearch",
            [0x008F] = "ChooseRivalName",
            [0x0090] = "GetCounterpartSprite",
            [0x0091] = "UpgradePokegear",
            [0x0092] = "RecordPokegearNumber", //to be confirmed
            [0x0093] = "IsTelNumberEntry",
            [0x0094] = "TelIncomingReservation",
            [0x0095] = "TelResetReserve",
            [0x0096] = "ReturnScreen",
            [0x0097] = "WiFiAutoReg",
            [0x0098] = "WiFiP2PMatchEventCall",
            [0x0099] = "WiFiP2PMatchSetDel",
            [0x009A] = "ImageClipSetProc",
            [0x009B] = "ImageClipPreviewTvProc",
            [0x009C] = "CustomBallEventCall",
            [0x009D] = "WorldMapScreen",
            [0x009E] = "BoxSetProc",
            [0x009F] = "OekakiBoardSetProc",
            [0x00A0] = "CallTrCard",
            [0x00A1] = "TradeListSetProc",
            [0x00A2] = "RecordCornerSetProc",
            [0x00A3] = "EndGameScreen",
            [0x00A4] = "PcDendouSetProc",
            [0x00A5] = "WorldTradeSetProc",
            [0x00A6] = "DPWInitProc",
            [0x00A7] = "StarterSelectionScreen",
            [0x00A8] = "EyeTrainerMoveSet",
            [0x00A9] = "EyeTrainerMoveCheck",
            [0x00AA] = "EyeTrainerTypeGet",
            [0x00AB] = "EyeTrainerIdGet",
            ...
            [0x00E2] = "ConnectSelParentWin",
            [0x00E3] = "ConnectSelChildWin",
            [0x00E4] = "ConnectDebugParentWin",
            [0x00E5] = "ConnectDebugChildWin",
            [0x00E6] = "DebugSioEncount",
            [0x00E7] = "DebugSioContest",
            [0x00E8] = "PkthSioTimingSend",
            [0x00E9] = "PkthSioTimingCheck",
            [0x00EA] = "PkthSystemCreate",
            [0x00EB] = "PkthSystemExit",
            [0x00EC] = "PkthMyEntryNoGet",
            [0x00ED] = "PkthMsgPrintFlagSet",
            [0x00EE] = "CheckPokerus",
            ...
            [0x00FC] = "SignatureScreen",
            [0x00FD] = "CheckSaveGame",
            [0x00FE] = "ReportSave",
            [0x00FF] = "ImageClipTvSaveDataCheck",
            [0x0100] = "ImageClipTvSaveTitle",
            [0x0101] = "CommTimingSyncStart",
            [0x0102] = "CommTempDataReset",
            [0x0103] = "UnionParentCardTalkNo",
            [0x0104] = "UnionGetInfoTalkNo",
            [0x0105] = "UnionBeaconChange",
            [0x0106] = "UnionConnectTalkDenied",
            [0x0107] = "UnionConnectTalkOk",
            [0x0108] = "UnionTrainerNameRegist",
            [0x0109] = "UnionReturnSetUp",
            [0x010A] = "UnionConnectCutRestart",
            [0x010B] = "UnionGetTalkNumber",
            [0x010C] = "UnionIdSet",
            [0x010D] = "UnionResultGet",
            [0x010E] = "UnionObjAllVanish",
            [0x010F] = "UnionScriptResultSet",
            [0x0110] = "UnionParentStartCommandSet",
            [0x0111] = "UnionChildSelectCommandSet",
            [0x0112] = "UnionConnectStart",
            [0x0113] = "MartScreen",
            [0x0114] = "SpMartScreen",
            ...
            [0x011A] = "HealPokemon",
            [0x011B] = "CommDirectEnd",
            [0x011C] = "CommDirectEnterBtlRoom",
            [0x011D] = "CommPlayerSetDir",
            [0x011E] = "UnionMapChange",
            [0x011F] = "UnionViewSetUpTrainerTypeSelect",
            [0x0120] = "UnionViewGetTrainerType",
            [0x0121] = "UnionViewMyStatusSet",
            [0x0122] = "CheckPokedex",
            [0x0123] = "GivePokedex",
            [0x0124] = "CheckShoes",
            [0x0125] = "GiveShoes",
            ...
            [0x012C] = "SetPartner",
            [0x012D] = "ClearPartner",
            [0x012E] = "SysFlagOneStepGet",
            [0x012F] = "SysFlagOneStepSet",
            [0x0130] = "SysFlagOneStepReset",
            ...
            [0x013A] = "InitGhostGym",
            [0x013B] = "SetGhostGymLightTask",
            [0x013C] = "DelGhostGymLightTask",
            [0x013D] = "VanishGhostGymLight",
            [0x013E] = "InitCombatGym",
            [0x013F] = "MoveCombatGymFall",
            [0x0140] = "InitElecGym",
            [0x0141] = "VermillionGymAnimation",
            [0x0142] = "VermillionGymBin",
            [0x0143] = "EntryElecGymSwitch",
            [0x0144] = "InitVioletGym",
            [0x0145] = "VioletGymElevator",
            [0x0146] = "InitInsectGym",
            [0x0147] = "AzaleaGym",
            [0x0148] = "AzaleaGym2",
            [0x0149] = "InitDragonGym",
            [0x014A] = "InitPoisonGym",
            [0x014B] = "InitAlmGym",
            ...
            [0x0159] = "TimeWaitIconAdd",
            [0x015A] = "TimeWaitIconDel",
            [0x015B] = "ReturnScriptWkSet",
            [0x015C] = "WaitTimeOrAB",
            [0x015D] = "PokeListSetProc",
            [0x015E] = "UnionPokeListSetProc",
            [0x015F] = "GetSelectedPartySlot",
            [0x0160] = "PokeStatusSetProc",
            [0x0161] = "PokeStatusGetResult",
            ...
            [0x0169] = "HikitoriPoke",
            [0x016A] = "FldKeepPokeAdd",
            [0x016B] = "FldKeepPokeReturnCheck",
            [0x016C] = "DeletePartyPokemon",
            [0x016D] = "DelSodateyaEgg",
            [0x016E] = "GetSodateyaEgg",
            [0x016F] = "HikitoriRyoukin",
            [0x0170] = "CompareMoneyFlex",
            [0x0171] = "EggHatchScreen",
            [0x0172] = "ShopSetProc",
            [0x0173] = "SodatePokeLevelStr",
            [0x0174] = "MsgAzukeSet",
            [0x0175] = "SetSodateyaPoke",
            ...
            [0x0183] = "GetSodateyaAishou",
            [0x0184] = "GetSodateyaTamagoCheck",
            ...
            [0x018A] = "WazaListSetProc",
            [0x018B] = "WazaListGetResult",
            [0x018C] = "GetMoveCount",
            [0x018D] = "DeleteMove",
            ...
            [0x0190] = "Strength",
            [0x0191] = "SysFlagFlash",
            [0x0192] = "SysFlagKiribarai",
            [0x0193] = "ImcAcceAddItem",
            [0x0194] = "ImcAcceAddItemChk",
            [0x0195] = "ImcAcceCheckItem",
            [0x0196] = "ImcBgAddItem",
            [0x0197] = "ImcBgCheckItem",
            [0x0198] = "BTowerAppSetProc",
            [0x0199] = "BattleTowerWorkClear",
            [0x019A] = "BattleTowerWorkInit",
            [0x019B] = "BattleTowerWorkRelease",
            [0x019C] = "BattleTowerTools",
            [0x019D] = "BattleTowerGetSevenPokeData",
            [0x019E] = "BattleTowerIsPrizeGet",
            [0x019F] = "BattleTowerIsPrizemanSet",
            [0x01A0] = "BattleTowerSendBuf",
            [0x01A1] = "BattleTowerRecvBuf",
            [0x01A2] = "BattleTowerGetLeaderRoomID",
            [0x01A3] = "BattleTowerIsLeaderDataExist",
            [0x01A4] = "RecordInc",
            [0x01A5] = "RecordGet",
            [0x01A6] = "RecordSet",
            [0x01A7] = "CheckCompleteJohtoDex",
            [0x01A8] = "CheckCompleteNationalDex",
            [0x01A9] = "ZukanRecongnize",
            [0x01AA] = "PokeMailChk",
            [0x01AB] = "PaperplaneSet",
            [0x01AC] = "PokeMailDel",
            ...
            [0x01B5] = "DummyGetVar",
            [0x01B6] = "GetOtherMsgArcID",
            [0x01B7] = "TalkMsgAllPutOtherArc",
            [0x01B8] = "TalkMsgOtherArc",
            [0x01B9] = "TalkMsgAllPutPMS",
            [0x01BA] = "TalkMsgPMS",
            [0x01BB] = "TalkMsgTowerApper",
            [0x01BC] = "TalkMsgNgPokeName",
            [0x01BD] = "GetPreviousHeaderID",
            [0x01BE] = "GetCurrentHeaderID",
            [0x01BF] = "SetSafariFlag",
            [0x01C0] = "ColosseumMapChangeIn",
            [0x01C1] = "ColosseumMapChangeOut",
            [0x01C2] = "GeonetScreen",
            [0x01C3] = "CommGetCurrentID",
            [0x01C4] = "ShowPokemonPic",
            [0x01C5] = "HidePokemonPic",
            [0x01C6] = "BtlSearcherDirMvSet",
            [0x01C7] = "MsgAutoGet",
            [0x01C8] = "PlayerHeightValid",
            [0x01C9] = "GetPokeSeikaku",
            [0x01CA] = "ChkPokeSeikakuAll",
            [0x01CB] = "ToudaiRecoverDemoCall",
            [0x01CC] = "GetTelBookFromTrID",
            [0x01CD] = "GetTelNumberEntryMsg",
            [0x01CE] = "ResetRevengeFlag",
            [0x01CF] = "StartGenerate",
            [0x01D0] = "AddRoamingPokemon",
            [0x01D1] = "UnionGroup",
            [0x01D2] = "RemaindWazaCount",
            [0x01D3] = "RemaindWazaListSetProc",
            [0x01D4] = "NormalWazaListSetProc",
            [0x01D5] = "OboeWazaListGetResult",
            [0x01D6] = "InitTrade",
            ...
            [0x01EA] = "DebugPrintWorkStationed",
            [0x01EB] = "DebugPrintFlagStationed",
            [0x01EC] = "PMSInputProc",
            [0x01ED] = "PMSInputDoubleProc",
            [0x01EE] = "PMSBuf",
            [0x01EF] = "CheckVersion",
            [0x01F0] = "FirstPokemonInParty",
            [0x01F1] = "TemotiPokeType",
            [0x01F2] = "AikotobaKabegamiSet",
            [0x01F3] = "GetAikotobaEgg",
            [0x01F4] = "SetUpPasoAnime",
            [0x01F5] = "StartPasoOnAnime",
            [0x01F6] = "StartPasoOffAnime",
            [0x01F7] = "GetLottoNumber",
            [0x01F8] = "CheckWinLotto",
            [0x01F9] = "InitLotto",
            [0x01FA] = "NickNamePC",
            [0x01FB] = "CountPCFreeSpace",
            [0x01FC] = "PokeParkControl",
            [0x01FD] = "PokeParkDepositCount",
            [0x01FE] = "PokeParkTransMons",
            [0x01FF] = "PokeParkGetScore",
            [0x0200] = "ReportDrawProcSet",
            [0x0201] = "ReportDrawProcDel",
            [0x0202] = "DendouBallAnm",
            [0x0203] = "AddScore",
            [0x0204] = "TextAccessory",
            [0x0205] = "CheckPokemonInParty",
            [0x0206] = "SetDeoxysForm",
            [0x0207] = "CheckBurmyForms",
            [0x0208] = "PoketchHookSet",
            [0x0209] = "PoketchHookReset",
            [0x020A] = "GetHour",
            [0x020B] = "ShakeOverworld",
            [0x020C] = "BlinkOverworld",
            [0x020D] = "CheckRegis",
            [0x020E] = "DressingImcAcceCheck",
            [0x020F] = "MessageUnown",
            ...
            [0x0218] = "ImcAcceSubItem",
            [0x0219] = "LevelJijiiInit",
            [0x021A] = "NewNankaiWordSet",
            [0x021B] = "RegularCheck",
            [0x021C] = "NankaiWordCompleteCheck",
            [0x021D] = "TextNumberSp",
            [0x021E] = "TemotiPokeContestStatusGet",
            [0x021F] = "CheckBirthday",
            [0x0220] = "MusicVolumeSet",
            [0x0221] = "CountSeenUnown",
            [0x0222] = "IsHaihuEventEnable",
            [0x0223] = "PokeWindowPutPP",
            [0x0224] = "PokeWindowAnm",
            [0x0225] = "PokeWindowAnmWait",
            [0x0226] = "DendouNumGet",
            [0x0227] = "SodateyaPokeListSetProc",
            [0x0228] = "SodateyaPokeListGetResult",
            [0x0229] = "GetRandomHit",
            [0x022A] = "CheckBtlPoint",
            [0x022B] = "AddBtlPoint",
            [0x022C] = "SubBtlPoint",
            [0x022D] = "CompBtlPoint",
            [0x022E] = "UnionViewGetTrainerTypeNo",
            [0x022F] = "BmpMenuMakeList16",
            [0x0230] = "HidenEffStart",
            [0x0231] = "ShakeCamera",
            [0x0232] = "Battle2vs2",
            [0x0233] = "ObjAnimePos",
            [0x0234] = "CheckMyGSID",
            [0x0235] = "GetFriendDataNum",
            [0x0236] = "PartyPokemonTradeScreen",
            [0x0237] = "GetCoinGift",
            [0x0238] = "AusuItemCheck",
            [0x0239] = "SubWkCoin",
            [0x023A] = "CompWkCoin",
            [0x023B] = "AikotobaOkurimonoChk",
            [0x023C] = "CBSealKindNumGet",
            [0x023D] = "WifiHusiginaokurimonoOpenFlagSet",
            [0x023E] = "MoveCodeGet",
            [0x023F] = "BgmPlayCheck",
            [0x0240] = "UnionGetCardTalkNo",
            [0x0241] = "WirelessIconEasy",
            [0x0242] = "WirelessIconEasyEnd",
            [0x0243] = "SaveFieldObj",
            [0x0244] = "SealName",
            [0x0245] = "TalkObjPauseAll",
            [0x0246] = "SetEscapeLocation",
            [0x0247] = "FieldObjBitSetFellowHit",
            [0x0248] = "DameTamagoChkAll",
            [0x0249] = "UnionBmpMenuStart",
            [0x024A] = "UnionBattleStartCheck",
            [0x024B] = "CommDirectEndTiming",
            [0x024C] = "HaifuPokeRetryCheck",
            [0x024D] = "WildBattleSp",
            [0x024E] = "CheckTrainerCardLevel",
            [0x024F] = "DummyRideBike",
            [0x0250] = "TalkMsgSpAuto",
            [0x0251] = "ShowSaveBox",
            [0x0252] = "HideSaveBox",
            [0x0253] = "ScopeMode",
            [0x0254] = "GetFollowingPokeSize",
            [0x0255] = "PairPoke_TestBallon",
            [0x0256] = "PairPoke_ChangePosition",
            ...
            [0x0261] = "MecScript",
            [0x0262] = "MoveSeamlessCamera",
            [0x0263] = "CallPokethlonProc",
            [0x0264] = "FldTradeChgMonsSex",
            [0x0265] = "GetRevengeItem",
            [0x0266] = "GetTelItemEvData",
            [0x0267] = "TakePhoto",
            [0x0268] = "GetPictureDataNum",
            [0x0269] = "PhotoAlbumCall",
            [0x026A] = "CheckAlbumPhoto",
            [0x026B] = "SysFlagDisguiseGet",
            ...
            [0x0275] = "Guru2SetProc",
            [0x0276] = "UnionGetRomCode",
            [0x0277] = "FrontierMonitor",
            [0x0278] = "TemotiPokeChkNum",
            [0x0279] = "BattleStageTools",
            [0x027A] = "BattleStageCommMonsNo",
            [0x027B] = "BattleStagePokeListGetResult",
            [0x027C] = "BattleStageSetContinueNG",
            [0x027D] = "BattleCastleTools",
            [0x027E] = "BattleCastleCommMonsNo",
            [0x027F] = "BattleCastlePokeListGetResult",
            [0x0280] = "BattleCastleSetContinueNG",
            [0x0281] = "ExtraSaveInit",
            [0x0282] = "ExtraSaveInitCheck",
            [0x0283] = "BattleRouletteTools",
            [0x0284] = "BattleRouletteCommMonsNo",
            [0x0285] = "BattleRoulettePokeListGetResult",
            [0x0286] = "BattleRouletteSetContinueNG",
            [0x0287] = "TemotiPokeChkGetPos",
            [0x0288] = "SeisekiBmpListStart",
            [0x0289] = "ScratchOffScreen",
            [0x028A] = "ReleaseScriptApp",
            [0x028B] = "ScratchItemGet",
            [0x028C] = "WazaOshieDataPageCount",
            [0x028D] = "WazaOshieBmpListStart",
            [0x028E] = "WazaOshieChgPokeWaza",
            [0x028F] = "WazaOshieGetBP",
            [0x0290] = "CheckHeadbuttCompatibility",
            [0x0291] = "TopBreederPowRndGet",
            [0x0292] = "StatusName",
            [0x0293] = "PokeFormChange",
            [0x0294] = "TrainerName",
            [0x0295] = "NumberNameEx32",
            [0x0296] = "GdsSetProc",
            [0x0297] = "WiFiLobbySetProc",
            [0x0298] = "SndDemo01DataLoad",
            [0x0299] = "SndFieldDataLoad",
            [0x029A] = "SndNowBgmNoGet",
            [0x029B] = "ContABKey",
            [0x029C] = "TypeName",
            [0x029D] = "GetItemNum",
            [0x029E] = "MezameruPawaaTypeGet",
            [0x029F] = "SetFavoritePoke",
            [0x02A0] = "GetFavoritePoke",
            [0x02A1] = "RotomuFormCheck",
            [0x02A2] = "TemotiRotomuFormChangeGet",
            [0x02A3] = "RotomuFormWazaChange",
            [0x02A4] = "TemotiRotomuFormNoGet",
            [0x02A5] = "BmpListStartLpCp",
            [0x02A6] = "VanishDummyObjAdd2",
            [0x02A7] = "VanishDummyObjDel2",
            [0x02A8] = "ScoreAdd",
            [0x02A9] = "ProfileBoyEvent",
            [0x02AA] = "HeapCheck",
            ...
            [0x02B0] = "EventGetTemotiPokeChkGetPos",
            [0x02B1] = "UnionPokeFormReturn",
            [0x02B2] = "SodateyaPokeFormReturn",
            [0x02B3] = "WflbyCounterTime",
            [0x02B4] = "BattleStageNumberName",
            [0x02B5] = "BattleStageRecordPokeGet",
            [0x02B6] = "BattleStageTotalRecordGetEx",
            [0x02B7] = "BmpListStartWidth",
            [0x02B8] = "GirathinaFormUpdate",
            [0x02B9] = "TVStageRensyouCheck",
            [0x02BA] = "HaihuPokeCheck",
            [0x02BB] = "FldOBJAllHeightVanishOFF",
            [0x02BC] = "FldOBJAllHeightVanishON",
            [0x02BD] = "TemotiItemChk",
            [0x02BE] = "WifiHistory",
            [0x02BF] = "SetFieldVolume",
            [0x02C0] = "RecordAdd",
            [0x02C1] = "RecordAddU32",
            [0x02C2] = "PcDendouDataCheck",
            [0x02C3] = "GetPokeSeeFlag",
            [0x02C4] = "FloorTrapAnimation",
            [0x02C5] = "AjitoAlarmEffectPlay",
            [0x02C6] = "AjitoD35R0103BMInit",
            [0x02C7] = "TalkFollowingPoke",
            [0x02C8] = "CallPkthRecord",
            [0x02C9] = "OpenAlphaPuzzle",
            [0x02CA] = "OpenRuinsofAlphHiddenRoom",
            [0x02CB] = "SodateyaObjSet",
            [0x02CC] = "SafariMapLayout",
            [0x02CD] = "SafariObjLayout",
            [0x02CE] = "SafariObjName",
            [0x02CF] = "SafariTalkObjGet",
            [0x02D0] = "SafariObjRemove",
            [0x02D1] = "IsSafariObjPlace",
            [0x02D2] = "CallLinearDemo",
            [0x02D3] = "BoatAnimation",
            [0x02D4] = "GetPkthlnSvData",
            [0x02D5] = "GetPkthlnFunNumCalc",
            [0x02D6] = "FieldSeSetup",
            [0x02D7] = "CallGetLivingPokeIdxTop",
            [0x02D8] = "PairPoke_WhiteFlash",
            [0x02D9] = "CheckPokemonAlive",
            [0x02DA] = "CheckFollowingPoke",
            [0x02DB] = "PairPoke_SetKairikiEff",
            [0x02DC] = "PairPoke_AddHumorVal",
            [0x02DD] = "GetBornPokemonPartyPos",
            [0x02DE] = "PairPoke_JumpAct",
            [0x02DF] = "GetBonguriBallNum",
            [0x02E0] = "ClearBonguriBall",
            [0x02E1] = "ExchangeBonguriBall",
            [0x02E2] = "GetBonguriAllNum",
            [0x02E3] = "CallBongCaseModeBall",
            [0x02E4] = "CallBongCaseModeShop",
            [0x02E5] = "BongJuiceShopGetParam",
            [0x02E6] = "PokeLvUpWazaCheck",
            [0x02E7] = "PkthRecWinCall",
            [0x02E8] = "PkthStatueObjSet",
            [0x02E9] = "PkthCourseName",
            ...
            [0x02F1] = "RockRslt",
            [0x02F2] = "HeadRslt",
            [0x02F3] = "AllocLegFldDemoWork",
            [0x02F4] = "FreeLegFldDemoWork",
            [0x02F5] = "AppLegBell",
            [0x02F6] = "AppLegReso",
            [0x02F7] = "AppLegEyes",
            [0x02F8] = "StartLegMapBellAnm",
            [0x02F9] = "SetLegCam",
            [0x02FA] = "MoveLegCam",
            [0x02FB] = "MoveLegCamWait",
            [0x02FC] = "DescendLegPoke",
            [0x02FD] = "StartLegWeather",
            [0x02FE] = "EndLegWeather",
            [0x02FF] = "InitLegAfApp",
            [0x0300] = "EndLegAfApp",
            [0x0301] = "ReturnLegCamera",
            [0x0302] = "AnnoonGetFormAtoZIsComp",
            [0x0303] = "PokethlonShopCall",
            [0x0304] = "PokethlonCardShopCall",
            [0x0305] = "CallLegendDemo",
            [0x0306] = "LegendFeatherEffectPlay",
            [0x0307] = "T29WataruSoratobiDemoPlay",
            [0x0308] = "GetUtsugiTogepii",
            [0x0309] = "IsUtsugiTogepii",
            [0x030A] = "GetGizamimiPityuu",
            [0x030B] = "RadioCheck",
            [0x030C] = "CallSlot",
            [0x030D] = "IsEventMailExist",
            [0x030E] = "ShopSaleCall",
            [0x030F] = "PairPoke_AppForbdn",
            [0x0310] = "OverlayManager",
            [0x0311] = "MushitoriSysControl",
            [0x0312] = "MushitoriRankingDataBufSet",
            [0x0313] = "MushitoriGetMyResult",
            [0x0314] = "MushitoriCapturePokeGet",
            [0x0315] = "MushitoriRestTimeSet",
            [0x0316] = "MushitoriTrainerEntryCheck",
            [0x0317] = "SafariMissionClearCheck",
            [0x0318] = "SafariEventKeyTimeSet",
            [0x0319] = "NumSelSubLCDCall",
            [0x031A] = "CompDeposit",
            [0x031B] = "ShowMomMoney",
            [0x031C] = "HideMomMoney",
            [0x031D] = "DepositWrite",
            [0x031E] = "GetRegulationCupName",
            [0x031F] = "GetRegulationCupNameWork",
            [0x0320] = "RegulationSet",
            [0x0321] = "RegulationWinPut",
            [0x0322] = "RegulationWinDel",
            [0x0323] = "RegulationPokeCheck",
            [0x0324] = "SetPGearMapOpenLevel",
            [0x0325] = "LoadSeSceneData",
            [0x0326] = "SheimiFormRev",
            [0x0327] = "TrHouseStIsEnableTrainer",
            [0x0328] = "TrHouseBattleCall",
            [0x0329] = "TrHouseTalkAppearMsg",
            [0x032A] = "TimeLeapEff",
            [0x032B] = "DepositItemStockGet",
            [0x032C] = "DepositItemStockDel",
            [0x032D] = "DepositItemStockCheck",
            [0x032E] = "NamiBGMForbdn",
            [0x032F] = "Call_SubLcdSelectReserve",
            [0x0330] = "AnnoeneEff",
            [0x0331] = "FlashBallEff",
            [0x0332] = "InitArceusGmk",
            [0x0333] = "VanishArceusGmk",
            [0x0334] = "ChgArceusGmkAnm",
            [0x0335] = "AoiAikotobaParamGet",
            [0x0336] = "Safari_DataTrans",
            [0x0337] = "GetSafariNameWork",
            [0x0338] = "IsSafariDataAndDelete",
            [0x0339] = "CheckPokeLeafCrown",
            [0x033A] = "SetPokeLeafCrown",
            [0x033B] = "GetPokeForm",
            [0x033C] = "AddPokeContestParam",
            [0x033D] = "PairPoke_IsNeghbor",
            [0x033E] = "AcceGameChkComp",
            [0x033F] = "AcceGameGetAcceNo",
            [0x0340] = "AcceGameChkImcBgComp",
            [0x0341] = "AcceGameGetImcBgNoRnd",
            [0x0342] = "PokethlonShopCheck",
            [0x0343] = "PokethlonCardShopCheck",
            [0x0344] = "CheckJadeOrbRequirements",
            [0x0345] = "MysteryRegulationCheck",
            [0x0346] = "CheckMoneyFull",
            [0x0347] = "SetPerapSleepNG",
            [0x0348] = "CheckPokecenZoneID",
            [0x0349] = "BmpMenuListAlignRight",
            [0x034A] = "BmpMenuListAlignBottom",
